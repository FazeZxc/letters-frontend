...
export const Navbar = () => {
    ...
    return (
        <div className="flex flex-col">
            <div className="py-3 flex justify-between gap-1 shadow-xl rounded-md">
                ...
                <div className="group relative px-4 cursor-pointer dropdown dropdown-end">
                    <div className="flex flex-col h-10 w-10 items-center justify-center rounded-full hover:text-blue-500 ">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
